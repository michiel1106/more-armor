...
public class ModelBloodedLightningDragonArmor extends ModelLightningDragonArmor {
    ...
    private static final ResourceLocation BLOOD_FRAME_1 = new ResourceLocation("bcarmors:textures/models/armor/shocked_armor1.png");
    private static final ResourceLocation BLOOD_FRAME_LEGS_1 = new ResourceLocation("bcarmors:textures/models/armor/" + "shocked" + "_armor_legs1.png");
    private static final ResourceLocation BLOOD_FRAME_2 = new ResourceLocation("bcarmors:textures/models/armor/" + "shocked" + "_armor2.png");
    private static final ResourceLocation BLOOD_FRAME_LEGS_2 = new ResourceLocation("bcarmors:textures/models/armor/" + "shocked" + "_armor_legs2.png");
    private static final ResourceLocation BLOOD_FRAME_3 = new ResourceLocation("bcarmors:textures/models/armor/" + "shocked" + "_armor3.png");
    private static final ResourceLocation BLOOD_FRAME_LEGS_3 = new ResourceLocation("bcarmors:textures/models/armor/" + "shocked" + "_armor_legs3.png");
    private static final ResourceLocation BLOOD_FRAME_4 = new ResourceLocation("bcarmors:textures/models/armor/" + "shocked" + "_armor4.png");
    private static final ResourceLocation BLOOD_FRAME_LEGS_4 = new ResourceLocation("bcarmors:textures/models/armor/" + "shocked" + "_armor_legs4.png");
    private static final ResourceLocation BLOOD_FRAME_5 = new ResourceLocation("bcarmors:textures/models/armor/" + "shocked" + "_armor5.png");
    private static final ResourceLocation BLOOD_FRAME_LEGS_5 = new ResourceLocation("bcarmors:textures/models/armor/" + "shocked" + "_armor_legs5.png");
    private static final ResourceLocation BLOOD_FRAME_6 = new ResourceLocation("bcarmors:textures/models/armor/" + "shocked" + "_armor6.png");
    private static final ResourceLocation BLOOD_FRAME_LEGS_6 = new ResourceLocation("bcarmors:textures/models/armor/" + "shocked" + "_armor_legs6.png");
    private static final ResourceLocation BLOOD_FRAME_7 = new ResourceLocation("bcarmors:textures/models/armor/" + "shocked" + "_armor7.png");
    private static final ResourceLocation BLOOD_FRAME_LEGS_7 = new ResourceLocation("bcarmors:textures/models/armor/" + "shocked" + "_armor_legs7.png");
    private static final ResourceLocation BLOOD_FRAME_8 = new ResourceLocation("bcarmors:textures/models/armor/" + "shocked" + "_armor8.png");
    private static final ResourceLocation BLOOD_FRAME_LEGS_8 = new ResourceLocation("bcarmors:textures/models/armor/" + "shocked" + "_armor_legs8.png");
